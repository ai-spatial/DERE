...
from exp.exp_informer import Exp_MultiBranch_AddPure_AddCom_Finetune_ageindependentCom_ShareStructure
import torch
...
Exp = Exp_MultiBranch_AddPure_AddCom_Finetune_ageindependentCom_ShareStructure



for ii in range(args.itr):
    setting = '{}_{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_2step_{}'.format(args.model, args.data, 
    ...
    exp.train(setting=setting, stage='ageindep')

    # test             
    print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
    exp.test(setting= setting, stage='ageindep')
