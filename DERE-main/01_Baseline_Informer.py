...
from exp.exp_informer import Exp_Baseline
import torch
...
args.checkpoints = './checkpoints_finetune_mixdata_baseline' # location of model checkpoints
...
for ii in range(args.itr):
    ...
    for net in networks:
        ...
        setting = '{}_{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_Baseline_{}_{}'.format(args.model, args.data, 
        ...
        exp.train(setting=setting, stage='Onestep', paras='')
        # test             
        print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
        exp.test(setting= setting, stage='Onestep', paras='')
